		  			...
		  			<div class="container">
				  		<div class="row align-items-center justify-content-center">
				  			<div class="col-md-4 col-4 header-top-left no-padding">
				        		...
				        		<a class="contact-texts" href="mailto:support@colorlib.com">12341234@jumpjump.com</a>		
				  			</div>
				  			<div class="col-md-4 col-4 header-top-bottom no-padding">
				        		<h2>런투유 줄넘기 클럽</h2>			
				  			</div>
				  			<div class="col-md-4 col-4 header-top-right no-padding">
				        		<a class="contact-texts" href="tel:+440 123 12 658 439">+01012341234</a>
			...
			<section class="top-course-area section-gap">
				<div class="container">
					<div class="row section-title">
						<h1>신규 프로그램</h1>
						<p>지금 신청하면 싸게 해주겠다 좋은말로 할때 신청하자</p>
					</div>	
					<div class="row">
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made from 정윤재</a>
